...
def _sig_handler_1(signum, frame):
    ...
    print(f"{_c['p']}🔥 Created by: Abdullah Al Mamun From Tech By @The_Dark_Mamun🔥{_c['e']}")
    sys.exit(0)
...
def _print_banner():
    ...
    banner_lines = [
        ...
        "Mamun PYTHON CODEX",
        "",
        "PHONE SMS ATTACK BANGLADESH SIM",
        f"{_c['e']}{_c['c']}{'=' * 80}",
        ...
        f"{_c['p']}Created by: {_c['w']}@The_Dark_Mamun{_c['c']}",
        f"{'=' * 80}{_c['e']}"
    ]
...
if __name__ == "__main__":
    ...
    print(f"{_c['p']}Created by: Mamun l{_c['e']}\n")
